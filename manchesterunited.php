...
<div class=" CardClub card text-center mt-3">
  <div class="CARDCLUBSHEADER card-header ">
    <span class="ManTitle ">MANCHESTER UNITED</span>
  </div>
</div>
...
?>
      <div class="col-lg-6 mb-4">
        <h2 class="font-weight-normal mb-4 "> Manchester United F.C. </h2>
        ...
        <P> <img src=" <?php echo $players['imageStadium']; ?>  " alt="">  Ground: <?php echo $players['Stadium']; ?>       </P>
      </div>
...
?>
      ...
      <div class="col-lg-6 mb-4">
        ...
        <div class="d-grid mdb-lightbox">
          ...
          <figure class="item">
              <img src="image/old_trafford_5.jpg" />
...
?>
  <div class="card  col-xxl-4 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
...
<div class="container col-5">
        <p class="card-text" style="font-size: 65px; color:black;  letter-spacing: 0.04em;  font-family:'Lato', sans-serif;"> <?php echo $players['SquardNumber']; ?> </p>
...
?>
  <div class="card flex-fill  col-xxl-5 col-xl-5 ">
...
<div class="container col-5">
        <p class="card-text" style="font-size: 65px; color:black;  letter-spacing: 0.04em;  font-family:'Lato', sans-serif;"> <?php echo $playersdef['SquardNumber']; ?> </p>
...
<div class=" Card container d-flex flex-row flex-wrap" style="width: 96%; gap: 7px flex-fill">
<?php
while($playersmid = mysqli_fetch_assoc($result3)) {
?>
  <div class="card flex-fill col-xxl-4 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
...
<div class="container col-5">
        <p class="card-text" style="font-size: 65px; color:black;  letter-spacing: 0.04em;  font-family:'Lato', sans-serif;"> <?php echo  $playersmid['SquardNumber']; ?> </p>
...
<div class="container col-5">
        <p class="card-text" style="font-size: 65px; color:black;  letter-spacing: 0.04em;  font-family:'Lato', sans-serif;"> <?php echo $playersforward['SquardNumber']; ?> </p>
