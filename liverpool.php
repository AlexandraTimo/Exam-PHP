...
<div class=" CardClub card text-center mt-3">
  <div class="CARDCLUBSHEADER card-header ">
    <span class="LiverpoolTitle ">LIVERPOOL</span>
  </div>
</div>
...
?>
      <div class="col-lg-6 mb-4">
        <h2 class="font-weight-normal mb-4 ">Liverpool Football Club</h2>
...
?>
      ...
      <div class="col-lg-6 mb-4">
        ...
        <div class="d-grid mdb-lightbox">
          <figure class="item">
              <img src="image/liverpool.jpg" />
            
          </figure>
          <figure class="item">
              <img src="image/1l.jpg" />
...
?>
  <div class="card flex-fill col-xxl-4  ">
...
?>
  <div class="card flex-fill col-xxl-5 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
